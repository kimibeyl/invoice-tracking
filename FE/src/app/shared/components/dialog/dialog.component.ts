...
export class DialogComponent {
  dialog: InputSignal<DialogProperties> = input<DialogProperties>({} as DialogProperties);
  template: InputSignal<TemplateRef<any> | undefined> = input<TemplateRef<any | undefined>>();
